...
description: "视频手动介入式下载工具 - 用有头浏览器(用户可见、不自动关闭)打开视频页，拦截真实流地址并高速并行下载，合并后经用户验收再清理分片。适用于需要登录/短信验证码/滑动验证/观看密码/切换清晰度才能播放的付费或受限视频站点(优酷、腾讯视频、爱奇艺、B站等)。关键词：下载视频、视频下载、优酷下载、需要登录的视频、需要密码的视频、m3u8、ts分片合并"
version: "1.1.0"
author: "CodeBuddy AI"
created: "2026-09-06"
updated: "2026-09-06"
